...
abstract class YJModuleHelper
{
	 ...
	 */
	public static function renderModule($module, $yj_attribs = array())
	{
		static $chrome;
		...
		if (!isset($yj_attribs['yj_style'])) {
			$yj_attribs['yj_style'] = 'none';
		}

		//dynamically add outline style
		if (JRequest::getBool('tp') && JComponentHelper::getParams('com_templates')->get('template_positions_display')) {
			$yj_attribs['yj_style'] .= ' outline';
		}

		foreach(explode(' ', $yj_attribs['yj_style']) as $style)
		{
			...
			{
				$module->style = $yj_attribs['yj_style'];

				ob_start();
				$chromeMethod($module, $params, $yj_attribs);
