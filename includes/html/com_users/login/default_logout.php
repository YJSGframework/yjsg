...
<div class="yjsg-userpages logout <?php echo $this->pageclass_sfx?>">
	...
	<?php endif ; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" class="yjsg-form" method="post">
		<div>
