...
<fieldset class="adminform">
	<legend><?php echo JText::_('COM_TEMPLATES_MENUS_ASSIGNMENT'); ?></legend>
		<label id="jform_menuselect-lbl"><?php echo JText::_('JGLOBAL_MENU_SELECTION'); ?></label>
		<button id="toogleselection" type="button" class="btn btn-default">
		...
		<?php foreach ($menuTypes as &$type) : ?>
			<ul class="menu-links">
				<li><h3><?php echo $type->title ? $type->title : $type->menutype; ?></h3></li>
