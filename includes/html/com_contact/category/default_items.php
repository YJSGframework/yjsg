...
//$pagination = str_replace('inputbox','yjsg-form-element',$this->pagination->getLimitBox());
?>
<div class="contact">
	...
	<?php if (intval(JVERSION) >= 3 && $this->params->get('filter_field') != 'hide') :?>
		<fieldset class="yjsg-form-fieldset">
			<div class="yjsg-form-group-inline">
				...
				<input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="yjsg-form-element" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_CONTACT_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_CONTACT_FILTER_SEARCH_DESC'); ?>" />
				</div>
			</div>
		</fieldset>
	<?php endif; ?>
