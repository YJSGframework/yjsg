...
<?php if($topMenuLocation == 0 ){ ?>
  <?php if($default_menu_style == 6) { ?>
   <div id="topmenu_holder" class="topmodpoz<?php echo $navbar_class ?>">
      <div class="yjsg-menu top_menu_poz<?php echo $navbar_class.$setMenuWidth ?> inside-container">
          <jdoc:include type="modules" name="topmenupoz" style="raw" />
      </div>
   </div>
  <?php } else { ?>
  <div id="topmenu_holder" class="yjsgmega">
      <div class="yjsg-menu top_menu<?php echo $setMenuWidth?> inside-container">
