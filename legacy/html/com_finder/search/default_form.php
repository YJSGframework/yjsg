...
<form id="finder-search" class="form-form" action="<?php echo JRoute::_($this->query->toURI()); ?>" method="get">
	...
	<fieldset class="word form-fieldset">
		...
		<span class="clr"></span>
		<input type="text" name="q" id="q" size="30" value="<?php echo $this->escape($this->query->input); ?>" class="inputbox form-field" />
		...
		<?php else: ?>
			<button name="Search" type="" class="button"><span class="icon-search icon-white"></span> <?php echo JText::_('JSEARCH_FILTER_SUBMIT');?></button>
		<?php endif; ?>
		<?php if ($this->params->get('show_advanced', 1)): ?>
			<a id="advanced-search-toggle" class="button" href="#advancedSearch"><span class="icon-list"></span> <?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></a>
		<?php endif; ?>
</fieldset>
