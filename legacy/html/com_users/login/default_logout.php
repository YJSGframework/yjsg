...
?>
<div class="userpageswrap logout <?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" class="form-form" method="post">
		<div>
