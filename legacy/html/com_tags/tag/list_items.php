...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="yjsg-form-inline">
	<?php if ($this->params->get('filter_field') != 'hide' || $this->params->get('show_pagination_limit')) :?>
	<fieldset class="filters yjsg-fieldset-collapse form-fieldset">
		<?php if ($this->params->get('filter_field') !== '0') :?>
			<div class="btn-group">
				<label class="hidelabeltxt element-hide" for="filter-search">
